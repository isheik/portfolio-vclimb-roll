            ...
            <v-layout column align-content-center>
              ...
              >
                <p>
                  ...
                  Canada. <br >I enjoy programming and turning my
                  passion/coffee into codes &#x2615;
                </p>
              </v-flex>
              <v-flex xs12>
      ...
      <section class="works">
        <v-container>
          <v-layout wrap align-center>
            <v-flex xs12>
              <h3 class="headline text-xs-center">Personal works</h3>
            </v-flex>
              ...
              <v-layout row justify-space-around wrap align-center>
                ...
                <modal name="modal-opus13">
                  <div class="basic-modal">
                    ...
                    <h5>Description</h5>
                    <p>
                      A simple desktop twitter application built with Web
                      Technologies. The application allows users to view, post,
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      this.$axios
        ...
        .then(() => {
          this.submitted = true
          this.sendGtmFormSubmissionEvent()
        })
    },
    sendGtmViewLinkedinEvent() {
      this.$gtm.push({ event: "view_linkedin", click_id: "linkedin-link" })
    },
    sendGtmViewGithubEvent() {
      this.$gtm.push({ event: "view_github", click_id: "github-link" })
    },
